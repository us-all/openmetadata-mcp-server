#!/usr/bin/env node
// Measure MCP tool schema token cost.
...
const BASE_ENV = { OPENMETADATA_HOST: "http://x:8585", OPENMETADATA_TOKEN: "x" };

const SCENARIOS = [
  { label: "default", env: {} },
  { label: "narrow (search,core)", env: { OM_TOOLS: "search,core" } },
  { label: "typical (search,core,governance,quality,discovery)", env: { OM_TOOLS: "search,core,governance,quality,discovery" } },
];
